...
//
    ...
    public void setText(String action){
        switch (action){
            case "scoreA": scoreTextA.setText(String.valueOf(teamA.score));
                 break;
            case "faultA": faultTextA.setText(String.valueOf(teamA.fault));
                break;
            case "scoreB": scoreTextB.setText(String.valueOf(teamB.score));
                break;
            case "faultB": faultTextB.setText(String.valueOf(teamB.fault));
                break;
        }
